...
public:
  ...
  virtual void enterTransitionRules(SheetMusicParser::TransitionRulesContext *ctx) = 0;
  virtual void exitTransitionRules(SheetMusicParser::TransitionRulesContext *ctx) = 0;
