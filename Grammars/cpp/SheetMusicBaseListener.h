...
public:
  ...
  virtual void enterTransitionRules(SheetMusicParser::TransitionRulesContext * /*ctx*/) override { }
  virtual void exitTransitionRules(SheetMusicParser::TransitionRulesContext * /*ctx*/) override { }
